...
from .views import (
    ...
    CoachUpdateView, CoachDeleteView, GetIndividualClubView, GetIndividualPlayerView
)

urlpatterns = [
    path("clubs/", ClubCreateView.as_view()),
    path("clubs/list/", ClubListView.as_view()),
    path("clubs/<str:club_id>/", GetIndividualClubView.as_view()),
    path("clubs/<str:club_id>/delete/", ClubDeleteView.as_view()),
    ...
    path("players/<str:player_id>/view/", GetIndividualPlayerView.as_view()),
