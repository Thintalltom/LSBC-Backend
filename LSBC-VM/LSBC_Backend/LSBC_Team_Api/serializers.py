...
class ClubSerializer(serializers.Serializer):
    ...
    contact_information = serializers.CharField(max_length=100, required=False, allow_blank=True)
...
class PlayerSerializer(serializers.Serializer):
    ...
    position = serializers.CharField(max_length=50, required=False, allow_blank=True)
    height = serializers.FloatField(required=False)
    weight = serializers.FloatField(required=False)
    dob = serializers.DateField(required=False)
    jersey_number = serializers.IntegerField(required=False)
    jersey_color = serializers.CharField(max_length=20, required=False, allow_blank=True)
...
class CoachSerializer(serializers.Serializer):
    ...
    role = serializers.ChoiceField(choices=['Head Coach', 'Assistant Coach'], required=False)